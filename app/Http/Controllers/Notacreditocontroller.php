...
class NotacreditoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view($this->folderview.'.admin')->with(compact('current_user','sucursal','cboSucursal','entidad', 'title', 'titulo_registrar', 'ruta'));
    }
    ...
    public function create(Request $request)
    {
        ...
        //     $cboSucursal = Sucursal::where('id', '=', $current_user->sucursal_id)->pluck('nombre', 'id')->all();
        // }
        $cboMotivos = [''=>'Seleccione motivo'] + Motivonotacredito::pluck('nombre','id')->all();
        $formData = array('notacredito.store');
        $formData = array('route' => $formData, 'class' => 'form-horizontal', 'id' => 'formMantenimiento'.$entidad, 'autocomplete' => 'off');
        $boton    = 'Registrar';
        return view($this->folderview.'.mant')->with(compact('numero','cboMotivos','cboSucursal','venta', 'formData', 'entidad', 'boton', 'listar','current_user', 'conf_codigobarra'));
    }

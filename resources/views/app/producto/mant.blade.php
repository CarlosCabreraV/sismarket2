...
{!! Form::model($producto, $formData) !!}	
	...
	<div class="form-group">
		{!! Form::label('codigobarra', 'Cod. Barra:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
	...
	<div class="form-group">
        ...
        {!! Form::label('ganancia', '% Ganancia:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
		<div class="col-lg-3 col-md-3 col-sm-3">
    ...
    <div class="form-group">
		...
		{!! Form::label('igv', 'IGV:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
		<div class="col-lg-3 col-md-3 col-sm-3">
		...
		{!! Form::label('consumo', 'Cons. Tienda:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label', 'style' => 'display:none;')) !!}
    ...
    <div class="form-group" style="display: none;">
		{!! Form::label('precioventaespecial', 'P. Venta Especial:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
		<div class="col-lg-3 col-md-3 col-sm-3">
			{!! Form::text('precioventaespecial', null, array('class' => 'form-control input-xs', 'id' => 'precioventaespecial')) !!}
		</div>
	</div>
    <div class="form-group">
		{!! Form::label('stockminimo', 'Stock Minimo:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
		<div class="col-lg-3 col-md-3 col-sm-3">

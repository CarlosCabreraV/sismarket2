                ...
                <div class="row   py-2 px-1 my-2">
                    ...
                    <div class="col-md-6 col-lg-6 ">
                        <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                {!! Form::select('motivo', $cboMotivos, '', array('class' => 'form-control input-xs ', 'id' => 'motivo')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-sm table-condensed table-striped" id="tbDetalle">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="text-center"><input type="text" class="text-center" readonly='true' id="totalnotacredito" name="totalnotacredito"></td>
                        </tr>
                        <tr>
                            @if ($conf_codigobarra=="S")
                            <td colspan="3"></td>
    ...
    <script type="text/javascript">
        ...
        function agregarDetalles(detalles){
            ...
            detalles.forEach(detalle => {
                ...
                let subtotal = (detalle['precioventa']*detalle['cantidad']).toFixed(2);

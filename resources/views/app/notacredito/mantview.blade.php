                    ...
                    <div class="col-md-6 col-lg-6 ">
                        <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                {!! Form::date('fecha', $notacredito->fecha, array('class' => 'form-control input-xs', 'id' => 'fecha', 'readonly' => 'true')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 ">
                ...
                <div class="row   py-2 px-1 my-2">
                    <div class="col-md-6 col-lg-6 ">
                        <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                {!! Form::text('sucursal_id',$notacredito->sucursal->nombre, array('class' => 'form-control input-xs', 'id' => 'sucursal_id' , 'readonly'=>true)) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 ">
                        <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                {!! Form::text('motivo', $notacredito->motivo->nombre, array('class' => 'form-control input-xs ', 'id' => 'motivo' , 'readonly'=>true)) !!}
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            {!! Form::label('lbldocref', 'Documento referencia', array('class' => 'col-lg-12 col-md-12 col-sm-12 control-label')) !!}
                                <div class="col-lg-6 col-md-6 col-sm-12 input-group">
                                    <div class="col-lg-12 col-sm-12 col-md-12 pr-0">
                                        {!! Form::text('documento',$notacredito->movimiento->numero, array('class' => 'form-control input-xs', 'id' => 'documento' , 'readonly'=>true)) !!}
                                    </div>
                                </div>
                        ...
                        <div class="form-group ">
                            {!! Form::label('persona', 'Cliente', array('class' => 'col-lg-12 col-md-12 col-sm-12 control-label')) !!}
                                <div class="col-lg-12 col-md-12 col-sm-12 input-group">
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-md-12 pr-0">
                                        {!! Form::text('persona', $notacredito->persona->nombres, array('class' => 'form-control input-xs', 'id' => 'persona', 'readonly' => true)) !!}
                                    </div>
                                </div>
            ...
            <div class="row   py-2 px-1 my-2">
                <table class="table table-sm table-condensed table-striped" id="tbDetalle">
                    ...
                    <tbody>
                        @foreach ($detalles as $detalle)
                            <tr>
                                ...
                                <td class="text-center">{{$detalle->producto?$detalle->producto->codigobarra:'-'}}</td>
                                <td class="text-center">{{$detalle->producto?$detalle->producto->nombre:'-'}}</td>
                    ...
                    <tfoot>
                        ...
                        <td class="text-center"><input type="text" class="text-center" readonly='true' id="total" name="total" value="{{(number_format($notacredito->movimiento->total,2))}}" ></td>
                        </tr>
